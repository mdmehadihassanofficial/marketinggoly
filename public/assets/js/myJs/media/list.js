        ...
        init: function () {
            (t = document.querySelector("#kt_file_manager_list")) &&
                ...
                (() => {
                    ...
                    //let form = $("#modal_add_form")[0];
                    var actionURL = $("#kt_modal_upload_form").data(
                        "action-url"
                    );
                    ...
                    var r = new Dropzone(e, {
                        ...
                        acceptedFiles:
                            "image/jpeg,image/png,image/jpg,image/gif,image/webp", // Allowed formats
                        headers: {
                    ...
                    r.on("success", function (file, response) {
                        ...
                        if (response.success) {
                            var loadUrl =
                                $("#loadGalleryImage").data("loadurl");
                            console.log(loadUrl);
                            $("#loadGalleryImage").load(loadUrl);
                    ...
                    r.on("addedfile", function (o) {
                        (o.previewElement.querySelector(
                            ...
                            const e =
                                o.previewElement.querySelector(".progress-bar");
                            e.style.opacity = "1";
                            var t = 1,
                            ...
                            t
                                .querySelectorAll(".dropzone-item")
                                .forEach((e) => {
                                    e.style.display = "";
                                }),
                        ...
                        t
                            ...
                            .addEventListener("click", function () {
                                r.files.forEach((e) => {
                                    const t =
                                        e.previewElement.querySelector(
                                            ".progress-bar"
                                        );
                                    t.style.opacity = "1";
                                    var o = 1,
                        ...
                        r.on("queuecomplete", function (e) {
                            t.querySelectorAll(".dropzone-upload").forEach(
                                (e) => {
