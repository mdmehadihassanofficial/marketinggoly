...
$(document).on("click", ".update-emid", function () {
    ...
    $.get(SingleURL, function (single) {
        ...
        // Title Value Set
        $("#emailSubjectUpdate").val(single.emailSubject);

        // Social Media Item Selected
        if (single.emailCampaignId) {
            // Parse the JSON string to an array
            const emailCampaignId = JSON.parse(single.emailCampaignId); // Assuming `single.socialMedia` is a JSON string like '["Twitter", "Linkedin"]'

            // Set the selected values for the select2 input
            $("#emailCampaignIdUpdate").val(emailCampaignId).trigger("change"); // Directly pass the array of values
        }

        // Social Post Template Item Selected
        if (single.emailTemplateId) {
            // Parse the JSON string to an array
            const emailTemplateIdUpdate = JSON.parse(single.emailTemplateId); // Assuming `single.socialMedia` is a JSON string like '["Twitter", "Linkedin"]'

            // Set the selected values for the select2 input
            $("#emailTemplateIdUpdate")
                .val(emailTemplateIdUpdate)
                .trigger("change"); // Directly pass the array of values
        }
