...
<div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-fluid ">
                ...
                <div class="card">
                        ...
                        <!--end::Card header-->
                        <input type="hidden" id="selectDeleteItem" value="{{route('user.emailCampaignCatSelectDelete')}}" data-redirectUrl="{{route('user.emailCampaignCat.index')}}">
                        <!--begin::Card body-->
                        <div class="card-body pt-0" >
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 shortLinkDivRefresh" id="dataTable"> 
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                                @foreach ($emailCampaignCat as $data )
                                                        ...
                                                        <td class="text-end">
                                                                ...
                                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                        ...
                                                                        <div class="menu-item px-3">
                                                                                <a href="javascript:void(0);" class="menu-link px-3 update-data" data-single="{{route('user.emailCampaignCat.edit', $data->id)}}" 
                                                                                        data-updateurl="{{route('user.emailCampaignCat.update', $data->id)}}" data-bs-toggle="modal"
                                                                        ...
                                                                        <!--begin::Menu item-->
                                                                        <div class="menu-item px-3">
                                                                                <a href="javascript:void(0);" class="menu-link px-3 delete-data" data-url="{{route('user.emailCampaignCat.destroy', $data->id)}}"
                                                                                        
                                                                                         data-redirecturl="{{route('user.emailCampaignCat.index')}}">
                                                                                        Delete
                                                                                </a>
                                                                        </div>
                                                                        <!--end::Menu item-->
                                                                        ...
                                                                        <div class="menu-item px-3 menu-item-deactive" style="@if($data->status == 0) display:none @endif">
                                                                                <a href="javascript:void(0);" class="menu-link px-3 deactive-data" data-url="{{route('user.emailCampaignCatDeactive', $data->id)}}">
                                                                                        Deactive
                                                                                </a>
                                                                        </div>
                                                                       
                                                                        <div class="menu-item px-3 menu-item-active"  style="@if($data->status == 1) display:none @endif">
                                                                                <a href="javascript:void(0);" class="menu-link px-3 active-data" data-url="{{route('user.emailCampaignCatActive', $data->id)}}"">
                                                                                        Active
                                                                                </a>
                                                                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                        ...
                                        <form class="form" action="#" id="modal_add_form"
                                                data-kt-redirect="{{route('user.emailCampaignCat.index')}}" data-kt-action-url="{{route('user.emailCampaignCat.store')}}" enctype="multipart/form-data" method="post">
                                                <!--begin::Modal header-->
                                                ...
                                                <div class="modal-body py-10 px-lg-17">
                                                        ...
                                                        <div class="scroll-y me-n7 pe-7"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                        <!--begin::Label-->
                                                                        <label
                                                                                class="required fs-6 fw-semibold mb-2" for="campaignCategory">Campaign Category</label>
                                                                        <!--end::Label-->

                                                                        <!--begin::Input-->
                                                                        <input type="text"
                                                                                class="form-control form-control-solid"
                                                                                placeholder="Email Template Title Here" id="campaignCategory" name="campaignCategory"
                                                                                 />
                                                                        <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                        ...
                                        <form class="form" action="#" id="modal_update_form"
                                                data-kt-redirect="{{route('user.emailCampaignCat.index')}}" data-kt-action-url="{{route('user.emailCampaignCat.update', 1)}}" enctype="multipart/form-data">
                                                @method('PUT')
                                                <!--begin::Modal header-->
                                                <div class="modal-header" id="modal_update_header">
                                                        <!--begin::Modal title-->
                                                        <h2 class="fw-bold">
                                                                Update Your Campaign Category 
                                                        </h2>
                                                        <!--end::Modal title-->
                                                ...
                                                <div class="modal-body py-10 px-lg-17">
                                                        ...
                                                        <div class="scroll-y me-n7 pe-7"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                        <!--begin::Label-->
                                                                        <label
                                                                                class="required fs-6 fw-semibold mb-2" for="campaignCategoryUpdate">Campaign Category</label>
                                                                        <!--end::Label-->

                                                                        <!--begin::Input-->
                                                                        <input type="text"
                                                                                class="form-control form-control-solid"
                                                                                placeholder="Short URL Title Here" id="campaignCategoryUpdate" name="campaignCategory"
                                                                                 />
                                                                        <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
