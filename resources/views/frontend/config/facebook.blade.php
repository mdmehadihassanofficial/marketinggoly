        ...
        <div id="kt_app_content_container" class="app-container  container-fluid ">
                ...
                <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <!--begin::Title-->
                                <h2 class="fs-2x fw-bold mb-0">Facebook Configuration Setup</h2>
                                <!--end::Title-->

                                <!--begin::Description-->
                                <p class="text-gray-500 fs-4 fw-semibold py-7">
                                        Click on the below buttons to setup <br/> Facebook. </p>
                                <!--end::Description-->
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                        ...
                                        <form class="form" action="#" id="modal_add_form"
                                                data-kt-redirect="{{route('user.facebookConfigView')}}" data-kt-action-url="{{route('user.facebookLogin')}}" enctype="multipart/form-data" method="post">
                                                <!--begin::Modal header-->
                                                ...
                                                <div class="modal-body py-10 px-lg-17">
                                                 <p style="color: #99a1b7">Call Back Route: <b>{{route('user.facebookCallBack')}}</b></p>
                                                        <!--begin::Scroll-->
                                                        <div class="scroll-y me-n7 pe-7"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                        <!--begin::Label-->
                                                                        <label
                                                                                class="required fs-6 fw-semibold mb-2" for="appID">App ID</label>
                                                                        <!--end::Label-->

                                                                        <!--begin::Input-->
                                                                        <input type="text"
                                                                                class="form-control form-control-solid"
                                                                                 id="appID" placeholder="App ID" value="" name="appID"
                                                                                 />
                                                                        <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                        <!--begin::Label-->
                                                                        <label
                                                                                class="required fs-6 fw-semibold mb-2" for="appSecret">App Secret</label>
                                                                        <!--end::Label-->

                                                                        <!--begin::Input-->
                                                                        <input type="text"
                                                                                class="form-control form-control-solid"
                                                                                        id="appSecret" placeholder="App Secret" value="" name="appSecret"
                                                                                        />
                                                                        <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
